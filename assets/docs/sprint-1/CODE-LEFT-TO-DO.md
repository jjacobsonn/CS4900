...
| **Versioning (Phase 2)** | Design in `sprint-1/versioning-spec.md` then implement: backend tables/endpoints (e.g. versions list, submit for review, revert), frontend Versions UI. |
